...
![Dashboard Overview](Power%20BI/screenshots/page1_overview.png)
...
![Deep Dive Dashboard](Power%20BI/screenshots/page2_deepdive.png)
...
3. **SQL Analysis**
   Import `Data/zomato_clean.csv` into a MySQL database and run `SQL/zomato.sql` to recreate the table and queries.
4. **Power BI Dashboard**
   Open `Power BI/zomato.pbix` in Power BI Desktop (or import `Data/zomato_clean.csv` directly using Get Data → Text/CSV).
